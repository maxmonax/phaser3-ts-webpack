export class EaseUtils {
  ...
  public static easeSine(x: number, aEase = EaseUtils.inOut): number {
    switch (aEase) {
      case EaseUtils.In:
        return this.easeInSine(x);
      case EaseUtils.Out:
        return this.easeOutSine(x);
      default:
        return this.easeInOutSine(x);
    }
  }
  ...
  public static easeQuad(x: number, aEase = EaseUtils.inOut): number {
    switch (aEase) {
      case EaseUtils.In:
        return this.easeInQuad(x);
      case EaseUtils.Out:
        return this.easeOutQuad(x);
      default:
        return this.easeInOutQuad(x);
    }
  }
  ...
  public static easeCubic(x: number, aEase = EaseUtils.inOut): number {
    switch (aEase) {
      case EaseUtils.In:
        return this.easeInCubic(x);
      case EaseUtils.Out:
        return this.easeOutCubic(x);
      default:
  ...
  public static easeQuart(x: number, aEase = EaseUtils.inOut): number {
    switch (aEase) {
      case EaseUtils.In:
        return this.easeInQuart(x);
      case EaseUtils.Out:
        return this.easeOutQuart(x);
      default:
        return this.easeInOutQuart(x);
    }
  }
  ...
  public static easeQuint(x: number, aEase = EaseUtils.inOut): number {
    switch (aEase) {
      case EaseUtils.In:
        return this.easeInQuint(x);
      case EaseUtils.Out:
        return this.easeOutQuint(x);
      default:
        return this.easeInOutQuint(x);
    }
  }
  ...
  public static easeExpo(x: number, aEase = EaseUtils.inOut): number {
    switch (aEase) {
      case EaseUtils.In:
        return this.easeInExpo(x);
      case EaseUtils.Out:
        return this.easeOutExpo(x);
      default:
        return this.easeInOutExpo(x);
    }
  }
  ...
  public static easeCirc(x: number, aEase = EaseUtils.inOut): number {
    switch (aEase) {
      case EaseUtils.In:
        return this.easeInCirc(x);
      case EaseUtils.Out:
        return this.easeOutCirc(x);
      default:
        return this.easeInOutCirc(x);
    }
  }
  ...
  public static easeElastic(x: number, aEase = EaseUtils.inOut): number {
    switch (aEase) {
      case EaseUtils.In:
        return this.easeInElastic(x);
      case EaseUtils.Out:
        return this.easeOutElastic(x);
      default:
        return this.easeInOutElastic(x);
    }
  }
  ...
  public static easeBounce(x: number, aEase = EaseUtils.inOut): number {
    switch (aEase) {
      case EaseUtils.In:
        return this.easeInBounce(x);
      case EaseUtils.Out:
        return this.easeOutBounce(x);
      default:
        return this.easeInOutBounce(x);
    }
  }
}
